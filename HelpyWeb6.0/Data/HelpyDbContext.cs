...
namespace HelpyAdmin.Data
{
    public class HelpyDbContext : IdentityDbContext<Users, Roles, int>
    {
        ...
        public DbSet<PrivatePhotoAccess> PrivatePhotoAccess { get; set; }
        public DbSet<Feedback> Feedbacks { get; set; }
        public DbSet<Message> Messages { get; set; }
        public DbSet<Chat> Chats { get; set; }
        public DbSet<UserChat> UserChats { get; set; }
        public DbSet<UserSubscriptionDetail> UserSubscriptionDetails { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // Register GetAllUserDetails as a keyless entity
            modelBuilder.Entity<UserDetailModel>();

            // Configure relationships between Message and Chat
            ...
            // Configure relationships between Message and Users
            modelBuilder.Entity<Message>()
                .HasOne(m => m.Sender)
                .WithMany()
            ...
            // Configure relationships between Chat and Users
        ...
        public async Task<List<GetAllUserDetails>> GetAllUserDetailsAsync(FilterUserModel model, string csvSelectedItems)
        {
            ...
            var minHeightInInchesParam = new MySqlParameter("@inputMinHeightInInches", model.MinHeightInInches ?? (object)DBNull.Value);
            var maxHeightInInchesParam = new MySqlParameter("@inputMaxHeightInInches", model.MaxHeightInInches ?? (object)DBNull.Value);
            ...
            var lookingForParam = new MySqlParameter("@inputLookingFor", model.LookingFor ?? (object)DBNull.Value);
            var radiusParam = new MySqlParameter("@inputRadius", model.Radius ?? (object)DBNull.Value);
            var query = "CALL GetUserDetails(@inputUserId,@inputMinAge,@inputMaxAge, @inputGender, @inputOccupation,@inputBodyType,@inputChildren,@inputEducation,@inputEthnicity,@inputFullName,@inputMinHeightInInches,@inputMaxHeightInInches,@inputLanguage,@inputRelationshipStatus,@inputSexuality,@inputSmoking,@inputSelectedItems,@inputCity,@inputCountry,@inputLongitude,@inputLatitude,@inputLookingFor,@inputRadius)";
            ...
            using (var command = this.Database.GetDbConnection().CreateCommand())
            {
                ...
                command.Parameters.Add(minHeightInInchesParam);
                command.Parameters.Add(maxHeightInInchesParam);
                ...
                command.Parameters.Add(lookingForParam);
                ...
                using (var result = await command.ExecuteReaderAsync())
                {
                    ...
                    while (await result.ReadAsync())
                    {
                        ...
                        userDetails.Add(new GetAllUserDetails
                        {
                            ...
                            Intentions = result.IsDBNull(result.GetOrdinal("Intentions")) ? null : result.GetString(result.GetOrdinal("Intentions")),
                            ...
                            LookingFor = result.IsDBNull(result.GetOrdinal("LookingFor")) ? null : result.GetString(result.GetOrdinal("LookingFor")),
                            isProfileVerified = result.GetBoolean(result.GetOrdinal("isProfileVerified"))
                        });
                    }
        ...
        public async Task<List<GetAllUserDetails>> GetAllUsersAsync(string gender, string sexuality, int currentUserId)
        {
            ...
            var userIdParam = new MySqlParameter("@inputUserId", currentUserId);


            var query = "CALL GetAllUser(@inputGender,@inputSexuality,@inputUserId)";
                ...
                using (var result = await command.ExecuteReaderAsync())
                {
                    ...
                    while (await result.ReadAsync())
                    {
                        ...
                        userDetails.Add(new GetAllUserDetails
                        {
                            ...
                            Longitude = result.IsDBNull(result.GetOrdinal("Longitude")) ? null : result.GetString(result.GetOrdinal("Longitude")),
                            Latitude = result.IsDBNull(result.GetOrdinal("Latitude")) ? null : result.GetString(result.GetOrdinal("Latitude")),
                            TotalGhostEntries = result.GetInt32(result.GetOrdinal("TotalGhostEntries")),
                            LookingFor = result.IsDBNull(result.GetOrdinal("LookingFor")) ? null : result.GetString(result.GetOrdinal("LookingFor")),
                            isProfileVerified = result.GetBoolean(result.GetOrdinal("isProfileVerified"))
                        });
                    }
